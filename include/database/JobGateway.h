...
namespace balancedbanana::database {
    ...
    public:
         ...
         */
        static uint64_t addJob(job_details details);
         ...
         */
        static bool removeJob(uint64_t id);
         ...
         * @return true if the operation was successful, otherwise false.
         */
        static bool startJob(uint64_t job_id, uint64_t worker_id, const Specs& specs, const QDateTime& start_time);
