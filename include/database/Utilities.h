...
namespace balancedbanana::database {
    ...
    public:
         ...
         */
        static bool doesTableExist(const std::string& table_name, const QSqlDatabase& database);
         ...
         */
        static bool doesRecordExist(const std::string& table_name, uint64_t id, const QSqlDatabase& db);
