    ...
    namespace scheduler {
        ...
        public:
            ...
            Job(uint32_t id, QDateTime started_at, QDateTime scheduled_at, QDateTime finished_at,
                uint32_t allocated_ram, uint32_t allocated_cores, std::string allocated_osIdentifier,
            ...
            std::string getAllocated_osIdentifier() const;
            ...
            void setAllocated_osIdentifier(std::string allocated_osIdentifier);
        ...
        private:
            ...
            std::string allocated_osIdentifier_;
            std::string command_;
            uint64_t worker_id_;
