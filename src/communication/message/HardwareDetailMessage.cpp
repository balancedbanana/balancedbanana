...
HardwareDetailMessage::HardwareDetailMessage(uint32_t coreCount, uint64_t ramSize, std::string  osIdentifier) :
...
uint64_t HardwareDetailMessage::GetRamSize() const {
    return ramSize;
}
