...
int ClientCommandLineProcessor::process(int argc, const char*const* argv, const std::shared_ptr<communication::Task>& task)
{
    ...
    auto mic = runSubCommand->add_option("--min-cpu-count,-c", min_cpu_count, "Minimum amount of wanted CPU Cores");
