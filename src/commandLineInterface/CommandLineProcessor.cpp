#include "../../include/commandLineInterface/CommandLineProcessor.h"
...
{
    bool isClient = strcmp(argv[0], CLIENT_PROGRAM_NAME) == 0;
    bool isServer = strcmp(argv[0], SERVER_PROGRAM_NAME) == 0;
    bool isWorker = strcmp(argv[0], WORKER_PROGRAM_NAME) == 0;

    // construct for storing all CL Arguments
    CLI::App app;
...
configfiles::Priority CommandLineProcessor::evaluatePriority(std::string& priority)
{
